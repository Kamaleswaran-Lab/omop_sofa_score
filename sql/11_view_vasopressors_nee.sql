...
SELECT d.person_id, d.drug_exposure_start_datetime AS charttime, d.drug_concept_id,
    d.quantity, d.dose_unit_source_value,
    CASE WHEN d.drug_concept_id IN (4328749,1321341) THEN d.quantity * 1.0
