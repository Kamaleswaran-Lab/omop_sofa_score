-- Standard infection onset (72h window) - MGH schema fix
...
WITH abx AS (
  ...
  JOIN results_site_a.assumptions a 
    ON a.domain='antibiotic' AND a.concept_id = de.drug_concept_id
