...
WITH base AS (
  SELECT
      ...
      MAX(CASE WHEN m.measurement_concept_id IN (3024171, 2000000223, 2147483344) THEN m.value_as_number END) AS resp_rate,
      MAX(CASE WHEN m.measurement_concept_id IN (2147483345, 4196147) THEN m.value_as_number END) AS spo2
